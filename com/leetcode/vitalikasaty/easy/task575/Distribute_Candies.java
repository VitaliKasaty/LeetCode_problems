package com.leetcode.vitalikasaty.easy.task575;
...
class Solution {
	public int distributeCandies(int[] candyType) {
		...
		int countCandyType = (int) Arrays.stream(candyType).distinct().count();
		int countCanEat = candyType.length / 2;

		return countCanEat >= countCandyType ? countCandyType : countCanEat;
	}
}
